  ...
  return (
    <div className="max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center">
      <main>
        ...
        <div className="mt-10 pt-10 border-t border-gray-600 flex flex-center justify-between text-gray-100">
      ...
      <Image src={appPreviewImg} alt="Dois celulares exibindo uma prévia da aplicação móvel" quality={100} />
    </div>
  )
}
